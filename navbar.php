<!-- navbar --> 
      <nav class="navbar navbar-expand-md navbar-light bg-light">
        <img src="img/logo_small.png" alt="" id="logo">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="createuser.php" style="color : white;"><b>Register User</b></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="transfermoney.php" style="color : white;"><b>Send Money</b></a>
              </li>
              <li class="nav-item">
