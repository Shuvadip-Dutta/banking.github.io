...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #D9EF6E;">
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Register User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/transfer.jpg" class="img-fluid">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #2785C4;">Send Money</button></a>
                  </div>
                  <div class="col-md act">
